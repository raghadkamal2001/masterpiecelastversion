        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-15">
          {books.map((book, index) => (
            ...
            >
              ...
              <h3 dir="rtl" className="text-lg font-bold mb-2 text-gray-800 transition-colors duration-300 hover:text-orange-500">{book.title}</h3>
